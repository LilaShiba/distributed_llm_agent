...
PORT = int(os.getenv("PORT", 5001))  # fucking apple and airplay
WORKER_URLS = os.getenv(
    "WORKER_URLS",
    "http://worker1:5001,http://worker2:5001",
)
...
#   - "sentence"  → MiniLM / E5 (recommended)
#   - "dpr"       → legacy dual-encoder DPR
RETRIEVAL_MODEL = os.getenv("RETRIEVAL_MODEL", "sentence")

# Sentence-transformer model (used when RETRIEVAL_MODEL=sentence)
EMBEDDING_MODEL = os.getenv(
    "EMBEDDING_MODEL",
    "sentence-transformers/all-MiniLM-L6-v2",
)

# DPR models (used when RETRIEVAL_MODEL=dpr)
...
# ---------------------------------------------------------------------
# All variables have defaults, so no strict checking
# ---------------------------------------------------------------------
